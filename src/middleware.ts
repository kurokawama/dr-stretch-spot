...
const PUBLIC_ROUTES = ["/login", "/signup", "/auth/callback", "/auth/magic", "/privacy", "/terms"];

// Role-based route prefixes
const ROLE_ROUTES: Record<string, string[]> = {
  trainer: ["/home", "/shifts", "/my-shifts", "/clock", "/earnings", "/profile", "/alerts", "/rank", "/evaluation-history", "/notifications", "/availability", "/resignation"],
  store_manager: ["/store"],
  hr: ["/hr"],

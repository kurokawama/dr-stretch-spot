...
| コンポーネント | ファイル | 役割 |
|---------------|---------|------|
| Server Actions | `src/actions/` (16ファイル, 5100+行) | 全ビジネスロジック |
...
| 共有コンポーネント | 3 | BottomNav, Header, ErrorState |
...
│   │   ├── auth/                     # OAuth Callback / Magic Link
│   │   ├── layout.tsx                # Root Layout
│   │   ├── error.tsx                 # Global Error Handler
│   │   └── globals.css               # Tailwind CSS
│   ├── actions/                      # Server Actions（16ファイル）
│   │   ├── admin.ts                  # 管理ダッシュボード
...
│   │   └── ...                       # 他11ファイル
│   ├── components/
│   │   ├── shared/                   # アプリ共有（Header, BottomNav, ErrorState）
...
"/login", "/register", "/auth/callback", "/auth/magic"
...
// 4. ロールベースルーティング
trainer       → /home, /shifts, /my-shifts, /clock, /earnings, /profile, ...
store_manager → /store/*
hr            → /hr/*
